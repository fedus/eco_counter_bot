...
counters = [
    ...
    CounterConfig(id="red_bridge", name="Rout Bréck",       url_template=Template("https://www.eco-visio.net/api/aladdin/1.0.0/pbl/publicwebpageplus/data/300022495?idOrganisme=4586&idPdc=300022495&fin=$end_date&debut=$start_date&interval=$interval&flowIds=353301699%3B353301700%3B353301701%3B353301702"))
]
